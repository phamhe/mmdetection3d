...
def create_deeproute_info_file(data_path,
    ...
    mmcv.dump(deeproute_infos_train, filename)
    ...
    mmcv.dump(deeproute_infos_val, filename)
    filename = save_path / f'{pkl_prefix}_infos_trainval.pkl'
    print(f'Deeproute info trainval file is saved to {filename}')
    mmcv.dump(deeproute_infos_train + deeproute_infos_val, filename)
    ...
    mmcv.dump(deeproute_infos_test, filename)
...
def _create_reduced_point_cloud(data_path,
    ...
    """
    deeproute_infos = mmcv.load(info_path)

    for info in mmcv.track_iter_progress(deeproute_infos):
        pc_info = info['point_cloud']
        image_info = info['image']
