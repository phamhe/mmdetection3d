...
from tools.data_converter import deeproute_converter as deeproute
...
def deeproute_data_prep(root_path, info_prefix, version, out_dir):
    """Prepare data related to Deeproute dataset.
    ...
    Args:
        ...
        out_dir (str): Output directory of the groundtruth database info.
    """
    deeproute.create_deeproute_info_file(root_path, info_prefix)
    # deeproute.create_reduced_point_cloud(root_path, info_prefix)
    create_groundtruth_database(
        'DeeprouteDataset',
        root_path,
        info_prefix,
